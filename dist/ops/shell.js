...
var shell = function (_a, args_1, _b) { return __awaiter(void 0, [_a, args_1, _b], void 0, function (_c, args, _d) {
    var result, spin, res, error_1;
    var _e = _c.attributes, sh = _e.sh, spinner = _e.spinner, sh_ignore_exit = _e.sh_ignore_exit, body = _c.body;
    var logger = _d.logger, exec = _d.exec;
