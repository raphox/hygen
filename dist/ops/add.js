...
var add = function (action_1, args_1, _a) { return __awaiter(void 0, [action_1, args_1, _a], void 0, function (action, args, _b) {
    var _c, to, inject, unless_exists, force, from, skip_if, result, prompter, absTo, shouldNotOverwrite, fileExists, shouldSkip, from_path, file, pathToLog;
    var logger = _b.logger, cwd = _b.cwd, createPrompter = _b.createPrompter;
    return __generator(this, function (_d) {
        switch (_d.label) {
            case 0:
                _c = action.attributes, to = _c.to, inject = _c.inject, unless_exists = _c.unless_exists, force = _c.force, from = _c.from, skip_if = _c.skip_if;
            ...
            case 1:
                ...
                return [4 /*yield*/, prompter
                        ...
                        type: 'confirm',
                        name: 'overwrite',
                        message: chalk_1.default.red("     exists: ".concat(to, ". Overwrite? (y/N): ")),
                    })
                        .then(function (response) { return response.overwrite; })];
            case 2:
                if (!(_d.sent())) {
                    logger.warn("     skipped: ".concat(to));
                    return [2 /*return*/, result('skipped')];
